...
?>
   ...
   <?php
    ...
    <tr>
        ...
        <td style="color: azure;"><a href="modifier_bd.php?idVoyageur=<?= $element['idVoyageur']?>">Modifier</a>
        <a href="supprimer.php?idVoyageur=<?= $element['idVoyageur']?>">Supprimer</a>
   ...
   <?php
    ...
    <tr>
        ...
        <td><a href="delAvion.php?idAvion=<?= $element['idAvion']?>">Supprimer</a></td>
    </tr>
    <?php } ?>
    </table>
