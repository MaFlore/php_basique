...
<head>
    ...
    <style>
        body{ font: 14px 'Roboto'; background-image: url('sign.jpg');}
...
<body>
    <center>
    <div class="wrapper">
        <h2 style="color:whitesmoke">Admin Account</h2>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p style="color:whitesmoke">Already have an account? <a href="./login.php">Login here</a>.</p>
        </form>
    </div>  
    </center>  
</body>
