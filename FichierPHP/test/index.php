...
<head>
    <meta charset="utf-8"/>
    <title>Acceuil</title>
    <link rel="stylesheet" href="../projetfinal/style.css">
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
        ...
        <li class="active" style="font-family: 'Times New Roman';">
             
            <?php 
                if(isset($_SESSION['username']))
                {
                    echo "<h2>Bienvenue Admin : ". $_SESSION['username']."</h2>";
                    echo '<a href="deconnexion.php"><span class="glyphicon glyphicon-log-in">  </span>  DECONNEXION</a>';
                }
                else
                {
